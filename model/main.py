...
def main():
    csv_file = 'D:\Random\VolumeControl-main\VolumeControl\csv conversion\Raw data.csv'  # Modify this line with your CSV file location
    ...
    model.save('D:\\Random\\VolumeControl-main\\VolumeControl\\model\\full_model.weights.h5') #Modify this line to save you model config
